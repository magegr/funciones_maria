...
function nou_Exercici($x) {
    $bloc = "<br/><hr/><br/><br/><b>Exercici $x comença ací:</b><br/>";
    echo $bloc;
}
...
function login(string $email, string $password) {
    if($email == 'mviel@exemple.com' && $password == 'florida') {
        return 'Hola Manel Viel';//una vez se ejecuta un return , ya no se ejecutan las lineas ded bajo
    }
...
function isLinkValid(string $link) {
    ...
    foreach ($inacceptables as $inacceptable) {
        if (strpos($link, $inacceptable) !== false ) {
            echo 'Trobat un inacceptable<br/>';
            return ;
        }
    }
     echo 'Acceptable<br/>';
