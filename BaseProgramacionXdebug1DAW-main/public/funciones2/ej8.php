<?php
/*Teniendo como referencia la página php.net - String Functions, investiga el funcionamiento de las funciones nativas de tratamiento de Strings
y realiza un programa en PHP que,en base al texto proporcionado, calcule los siguientes datos, 
cada uno a través de una función diferente:
...
$caracteres = strlen($textoSinEspacios);
echo "El número de caracteres, sin tener en cuenta los espacios o los saltos de línea es $caracteres";
$numtot= str_word_count($texto);
echo "el número de palabras es $numtot.";
$frases = preg_split('/[.!?]\s*/', $texto);
echo "el número de frases es $frases.";
?>